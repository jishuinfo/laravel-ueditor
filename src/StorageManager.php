...
namespace Jishuinfo\LaravelUEditor;
...
use Jishuinfo\LaravelUEditor\Events\Uploaded;
use Jishuinfo\LaravelUEditor\Events\Uploading;
use Jishuinfo\LaravelUEditor\Events\Catched;
...
class StorageManager
{
    ...
    private function download($url, $config)
    {
        ...
        $title = config('ueditor.hash_filename') ? md5($url) . '.' . ($ext?:'jpg') : $original;
